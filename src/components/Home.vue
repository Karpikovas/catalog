        ...
        <b-row>
          <b-col cols="2" class="position-fixed divider">
            <b-nav class="flex-sm-column text-center mt-2">
              ...
              <b-nav-item v-for="subdivision in subdivisions" v-on:click="changeFilter(subdivision.name)">
                {{subdivision.name }}
              </b-nav-item>
              <b-nav-item href="/subdivisions" class="mt-5">
                <b-button variant="outline-primary">Подробнее о подразделениях</b-button>
              </b-nav-item>
            </b-nav>
          </b-col>
          <b-col offset="2" class="flex-sm-column">
            ...
            >
              ...
              <template v-slot:row-details="row">
                <b-card :img-src="'http://musiclibrary/employees/' + row.item.id +'/photo?date=' + date"
                        img-alt="Card image" img-left img-width="168">
                  <b-row class="mb-2">
